-- First check if the RPC function exists and drop it
DROP FUNCTION IF EXISTS public.get_wedding_bookings_all();

-- Create the updated function that includes add-ons
...
-- Test the function
SELECT * FROM public.get_wedding_bookings_all() LIMIT 5;